 ...
 * @see Plugin
 */
public interface PluginContext extends HasVerticleName {
     ...
     */
    static PluginContext create(String pluginName, Path dataDir, String sharedKey, String deployId) {
        return new DefaultPluginContext(pluginName, dataDir, sharedKey, deployId);
    }
