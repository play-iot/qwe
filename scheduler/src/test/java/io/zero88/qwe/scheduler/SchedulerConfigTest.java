...
import io.zero88.qwe.scheduler.mock.MockSchedulerService;
...
public class SchedulerConfigTest {
    ...
    public void deserialize_custom() {
        SchedulerConfig from = IConfig.from(
            "{\"registerServiceClass\":\"io.zero88.qwe.scheduler.mock.MockSchedulerService\"," +
    ...
    public void deserialize_invalid_service_class_then_fallback() {
        final SchedulerConfig config = IConfig.from(
            "{\"registerServiceClass\":\"io.zero88.qwe.MockSchedulerService\"}", SchedulerConfig.class);
